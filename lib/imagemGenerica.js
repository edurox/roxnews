...
const PADRAO_NOME_GENERICO = /(favicon|apple-touch-icon|\/cropped-|\/logo(?:[._-]|$)|[._-]logo(?:[._-]|$)|logotipo|logomarca|\/icons?\/|[._-]icon(?:[._-]|$)|\/icon(?:[._-]|$)|[._-]icone(?:[._-]|$)|\/icone(?:[._-]|$)|avatar|placeholder|default[._-]?(cover|social|image|thumb)|og[._-]?default|social[._-]?default|sprite|brand[._-]?mark|site[._-]?icon)/i
