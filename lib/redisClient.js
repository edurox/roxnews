...
// `offset` é um cursor real sobre o ZSET global — não dependemos só do
// set de "vistas" pra saber onde parar (isso é o que causava o feed
// travar cedo demais: se a marcação de "vista" ainda não tinha sido
// persistida, a próxima página vinha idêntica à anterior).
